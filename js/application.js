...
templates['menu-content'] = template(function (Handlebars,depth0,helpers,partials,data) {
...
templates['tab-content'] = template(function (Handlebars,depth0,helpers,partials,data) {
  helpers = helpers || Handlebars.helpers;
...
function program1(depth0,data) {
  ...
  stack1 = depth0.title;
  foundHelper = helpers.getModuleId;
  stack1 = foundHelper ? foundHelper.call(depth0, stack1, {hash:{}}) : helperMissing.call(depth0, "getModuleId", stack1, {hash:{}});
  buffer += escapeExpression(stack1) + "\">\n    <ul class=\"nav nav-tabs nav-stacked nav-rest\">\n        ";
  stack1 = depth0.methods;
...
function program2(depth0,data) {
  ...
  foundHelper = helpers.getTabClass;
  stack1 = foundHelper ? foundHelper.call(depth0, stack1, {hash:{}}) : helperMissing.call(depth0, "getTabClass", stack1, {hash:{}});
  buffer += escapeExpression(stack1) + "\">\n            <div class=\"tab-header\">\n                <span class=\"label ";
  stack1 = depth0.method;
  foundHelper = helpers.getLabelClass;
  stack1 = foundHelper ? foundHelper.call(depth0, stack1, {hash:{}}) : helperMissing.call(depth0, "getLabelClass", stack1, {hash:{}});
  buffer += escapeExpression(stack1) + "\">";
  ...
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\n\n                <input type=\"hidden\" class=\"requestMethod\" value=\"";
  foundHelper = helpers.method;
  if (foundHelper) { stack1 = foundHelper.call(depth0, {hash:{}}); }
  else { stack1 = depth0.method; stack1 = typeof stack1 === functionType ? stack1() : stack1; }
  buffer += escapeExpression(stack1) + "\" />\n                <input type=\"hidden\" class=\"requestRoute\" value=\"";
  foundHelper = helpers.title;
  if (foundHelper) { stack1 = foundHelper.call(depth0, {hash:{}}); }
  else { stack1 = depth0.title; stack1 = typeof stack1 === functionType ? stack1() : stack1; }
...
function program4(depth0,data) {
  ...
  buffer += "\n</div>";
  return buffer;});
templates['nav-content'] = template(function (Handlebars,depth0,helpers,partials,data) {
  helpers = helpers || Handlebars.helpers;
...
function program1(depth0,data) {
  ...
  foundHelper = helpers.getModuleId;
  stack1 = foundHelper ? foundHelper.call(depth0, stack1, {hash:{}}) : helperMissing.call(depth0, "getModuleId", stack1, {hash:{}});
  buffer += escapeExpression(stack1) + "\" data-toggle=\"tab\"><i class=\"icon-book\"></i> ";
  foundHelper = helpers.title;
  if (foundHelper) { stack1 = foundHelper.call(depth0, {hash:{}}); }
  else { stack1 = depth0.title; stack1 = typeof stack1 === functionType ? stack1() : stack1; }
  buffer += escapeExpression(stack1) + "</a></li>\n";
  ...
  buffer += "<ul class=\"nav nav-list\" id=\"tabbedModules\">\n    <li class=\"nav-header\">API Modules</li>\n";
  stack1 = depth0.modules;
  stack1 = helpers.each.call(depth0, stack1, {hash:{},inverse:self.noop,fn:self.program(1, program1, data)});
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\n</ul>";
...
(function() {
  ...
  Handlebars.registerHelper("getModuleId", function(module) {
    return module.toLowerCase().replace(/\s/g, "");
  });

  Handlebars.registerHelper("getTabClass", function(method) {
    method = method.toLowerCase();
    return method + "-tab";
  });

  Handlebars.registerHelper("getLabelClass", function(method) {
    method = method.toLowerCase();
    switch (method) {
      case "get":
        return "label-info";
  ...
  Application = (function() {
    ...
    Application.prototype.open = function(data) {
      return $.getJSON('data/' + data, function(contents) {
        ...
        if (contents.user) {
          ...
          return config.password = contents.password;
        }
      });
    };
  ...
  Request = (function() {
    ...
    function Request(url, method, parameters, element) {
      this.url = url;
      this.method = method;
    ...
    Request.prototype.getParameters = function() {
      ...
      self = this;
      this.data = {};
      return this.parameters.each(function(index) {
        var name, value;
        name = $(this).attr('id');
        value = $(this).val();
        if (!name) {
  ...
  $(function() {
    ...
    $("#tabbedModules a").click(function(e) {
      e.preventDefault();
    ...
    return $(".try-button").live("click", function() {
      ...
      return new Request(config.baseUrl + route, method, params, element);
    });
  });
